...
3. Follow `docs/process/PROCESS.md` steps 2-8 exactly, including invoking rest-api-tester when (and only when) the step's `### Test` subsection calls for it, and the mandatory `docs/process/SELF_IMPROVE.md` pass before stopping.
